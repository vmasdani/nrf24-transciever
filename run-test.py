...
if __name__ == "__main__":
    ...
    parser.add_argument('address', type=str, nargs='?', defaulta='1SNSR', help="Address to listen to (3 to 5 ASCII characters)")
    ...
    # Spawn new thread for test transmi
    tx_thread = threading.Thread(target=tx_thread_function, args=(1,))
    tx_thread.start()
